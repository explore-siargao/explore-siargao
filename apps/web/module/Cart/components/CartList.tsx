  ...
  return (
    <>
      <div className="flex bg-white-100 mb-8 pb-4 justify-between items-center border-b">
        ...
        <InputCheckbox id={0} colorVariant="secondary"  checked={selectAll} onChange={toggleAllCheckboxes}/>
          ...
          <div key={cartItem.id} className=" bg-white pt-2">
            <div className="flex flex-col gap-8 sm:flex-row pt-4">
              <div className="lg:flex-none w-full sm:w-6 align-center">
                <InputCheckbox id={cartItem.id} colorVariant="secondary"  checked={selectedItems.includes(cartItem.id)} onChange={() => toggleCheckbox(cartItem.id)}/>
              </div>
