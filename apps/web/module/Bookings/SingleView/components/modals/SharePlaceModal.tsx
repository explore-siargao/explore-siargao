...
import { LucideCopy, LucideFacebook, LucideMail, LucideMessageCircle, LucideMessageCircleReply, LucideMessageSquareCode, LucideTwitter } from "lucide-react"
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-8 pb-12">
          <div className="flex-1 md:w-1/2 2xl:w-full">
            ...
            <Button
              ...
              variant={"shaded"}
              className="py-8  w-full space-x-2 pl-5 justify-start"
              onClick={()=>router.push("https://twitter.com/intent/post?source=tweetbutton&text=&url=https%3A%2F%2Fwww.airbnb.com%2Frooms%2F37250886%3Fcheck_in%3D2024-03-16%26check_out%3D2024-03-21%26guests%3D1%26adults%3D1%26s%3D5%26unique_share_id%3D4657d164-902d-4b35-90b2-4e0e445ba0de&related=airbnb")}
            >
          ...
          <div className="mt-4">
            <Button
              ...
              variant={"shaded"}
              className="py-8  w-full space-x-2 pl-5 justify-start"
              onClick={()=>window.location.href = 'mailto:recipient@example.com?subject=Hello&body=How are you?'}
            >
            ...
            <Button
              ...
              variant={"shaded"}
              className="py-8  w-full space-x-2 pl-5 justify-start"
              onClick={()=>router.push("https://www.facebook.com/sharer.php?u=https%3A%2F%2Fwww.airbnb.com%2Frooms%2F37250886%3Fcheck_in%3D2024-03-16%26check_out%3D2024-03-21%26guests%3D1%26adults%3D1%26s%3D4%26unique_share_id%3D807225a8-4974-467c-b64c-d2ed55be78e2&quote=")}
            >
