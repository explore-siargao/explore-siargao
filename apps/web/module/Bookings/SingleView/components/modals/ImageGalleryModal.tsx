        ...
        <ModalContainer isOpen={isOpen} onClose={onClose} size="full">
            <div className="relative space-y-1 pt-2 pb-20 h-screen overflow-y-auto">
                <div className="flex justify-center mb-2">
                    <Button variant="ghost"><Upload className="h-4 w-4 mr-1" strokeWidth="1"/><span className="underline">Share</span></Button>
                    <Button variant="ghost"><Heart className="h-4 w-4 mr-1" strokeWidth="1"/><span className="underline">Save</span></Button>
                </div>
                {imgSrc.map((data) => {
                    return (
