...
import { LucideAlarmClock, LucideAlarmSmoke, LucideAngry, 
        LucideBed, LucideBug, LucideCarFront, LucideCigaretteOff, 
        LucideWifi, } from "lucide-react"
  ...
  return (
    <TitleSection size="lg" title="What this place offers">
      ...
      <div className="grid grid-cols-2">
        ...
        <IconDescription icon={LucideAngry} desc="Angry people" isStrikeThrough/>
        <IconDescription icon={LucideAlarmClock} desc="Alarm clock" isStrikeThrough/>
        <IconDescription icon={LucideBug} desc="No bugs" isStrikeThrough/>
      </div>
      <Button className="mt-5" variant={"shaded"}>Show all 56 amenities</Button>
    </TitleSection>
  )
}
