        ...
        <>
            <div className="max-h-[50vh] overflow-y-auto">
                <div className="pt-5 pb-3 px-5">
                    <Typography variant="h2" fontWeight="semibold" className="mb-7">{subTitle}</Typography>
                                ...
                                onChange={() => {
                                    setSelectedOptions(selectedOptions => {
                                        if (selectedOptions.includes(selectable)) {
                                            return selectedOptions.filter(option => option !== selectable);
                                        } else {
            ...
            >
                ...
                onClick={() => {
                    if(selectedOptions.includes("Something else") || selectedOptions.includes("Somewhere else")) {
