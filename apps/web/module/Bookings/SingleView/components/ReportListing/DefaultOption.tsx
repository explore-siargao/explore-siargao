        ...
        <>
            <div className="max-h-[50vh] overflow-y-auto">
                <div className="pt-5 pb-3 px-5">
                    <Typography variant="h2" fontWeight="semibold">Why are you reporting this listing?</Typography>
                    <Typography variant="h4">This won’t be shared with the Host.</Typography>
                </div>
