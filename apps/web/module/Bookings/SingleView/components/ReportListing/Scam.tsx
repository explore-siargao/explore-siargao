...
const options = [
    {
        ...
        selectables: ["Bank or wire transfer", "Credit or debit card", "Cash", "Paypal", "MoneyGram", "Western Union", "Something else"]
    },
    {
        to: "scamSelectables",
        ...
        selectables: ["Photos", "Description", "House rules", APP_NAME + " message", "Somewhere else"]
    },
    {
        to: "scamSelectables",
...
const Scam = () => {
    ...
    const removeLastValue = useReportListingStore((state) => state.removeLastValue)
        ...
        <>
            <div className="max-h-[50vh] overflow-y-auto">
                <div className="pt-5 pb-3 px-5">
                    <Typography variant="h2" fontWeight="semibold">Why do you think it’s a scam?</Typography>            
                </div>
            ...
            <div
            className="justify-between border-t border-gray-300 flex items-center"
            >
                <Button
                variant="ghost"
