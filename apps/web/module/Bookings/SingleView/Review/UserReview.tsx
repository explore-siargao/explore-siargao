  ...
  return (
    <div>
      ...
      <Typography variant={"h5"} className="font-bold max-w-[420px] mt-2">
        We stayed here for three nights for the NY celebration. The place was
        spotless upon our arrival, providing a welcoming and comfortable
        atmosphere. Despite being designed for two to...
      </Typography>
