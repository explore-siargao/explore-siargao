...
export async function getListingDescriptionByListingId(listingId: number | undefined) {
  const apiService = new ApiService()
  return await apiService.get(`${API_URL_BOOKINGS}/listing-description/listing/${listingId}`)
}
