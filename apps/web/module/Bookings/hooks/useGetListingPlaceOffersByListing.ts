...
export async function getListingPlaceOffersByListingId(listingId: number | undefined) {
  const apiService = new ApiService()
  return await apiService.get(`${API_URL_BOOKINGS}/listing-place-offers/${listingId}`)
}
