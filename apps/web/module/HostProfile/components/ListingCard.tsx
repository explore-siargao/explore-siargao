...
const ListingCard = ({image, title, rating, description}: ListingCardProps) => {
    return (
        <div>
            <div className="relative h-60 w-full bg-gray-200 rounded-md">
                <Image src={`${ASSET_ROOT}/${image}`} layout="fill" objectFit="cover" className="rounded-full" alt="Listing image"/>
            </div>
