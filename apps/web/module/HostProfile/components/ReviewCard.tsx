...
const ReviewCard = ({reviewMessage, reviewerImage, reviewerName, reviewDate}: ReviewsCardProps) => {
        ...
        <div className="p-5 border rounded-md">
            ...
            <div className="flex items-center mt-5">
                <div className="relative h-14 w-14 bg-gray-200 rounded-full">
                    <Image src={`${ASSET_ROOT}/${reviewerImage}`} layout="fill" objectFit="cover" className="rounded-full" alt="Reviewer's profile"/>
                </div>
