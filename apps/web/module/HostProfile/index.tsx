            ...
            review: [
                {
                    ...
                    locationRates: 3,
                    valueRates: 4,
                    comment: "Wow wow wow This place and the beautiful hosts have captured our hearts for sure. We will definitely be back. Not often am I sad to leave a place, but I was today. David, Genny & Bert looked after us",
                ...
                },
                {
                    ...
                    locationRates: 3,
                    valueRates: 4,
                    comment: "Genny and David are great host. The location is very and lonely. Direct access to the sea with great area for snorkeling, diving or kayaking. A nice place for a few relaxing days by the sea",
                    createdAt: "2024-02-19T05:37:15.148Z",
                    updatedAt: "2024-02-19T05:37:15.148Z",
                    deletedAt: null,
                    listingId: 1,
            ...
            <div className="mt-5 mx-3 md:mx-40 lg:mx-5 grid lg:grid-cols-12 gap-x-20 gap-y-4">
                ...
                <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="items-center flex lg:hidden">
                            <FlagIcon className="h-5 w-5 mr-3"/>
                            <button className="underline font-semibold">Report this profile</button>
                        </div>   
                </div>
            </div>
        </WidthWrapper>
