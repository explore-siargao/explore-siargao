...
const tabs = [
    { name: "Graph", icon: <BarChart2 size={20}/>, link: "/hosting/payment-history/graph", isSelected: true  },
    { name: "Table", icon: <LucideTable size={20}/>, link: "/hosting/payment-history/table" },
  ];
  const summaryData = {
