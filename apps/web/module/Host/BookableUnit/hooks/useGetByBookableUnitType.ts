...
export async function getByBookableUnitType(bookableUnitTypeId: number | undefined) {
  const apiService = new ApiService("mock")
  return await apiService.get(`${API_URL_BOOKABLE_UNIT}/bookable-unit-type/${bookableUnitTypeId}`)
}
