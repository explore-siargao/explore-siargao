...
const ReviewCard = () => {
  ...
  const imageContainer = (...classes: any) => cn('flex-none', 'w-14', 'h-14', ...classes);
  const imageShape = (...classes: any) => cn('relative', 'h-14', 'w-14', 'bg-gray-200', ...classes);
    ...
    {isPending ? (
      ...
      {data?.items?.map((review) => (
        ...
        <div className="flex flex-col mb-4">
          ...
          </div><div className="flex items-center pt-4 md:bottom-0 border-b-2 border-gray-200 rounded-b dark:border-gray-600">
