...
const options = [
    {
        ...
        selectables: ["Bank or wire transfer", "Credit or debit card", "Cash", "Paypal", "MoneyGram", "Western Union"]
    },
    {
        to: "scamSelectables",
        ...
        selectables: ["Photos", "Description", "House rules", APP_NAME + " message"]
    },
    {
        to: "scamSelectables",
        ...
        <>
            <div className="max-h-[50vh] overflow-y-auto">
                <div className="pt-5 pb-3 px-5">
                    <Typography variant="h2" fontWeight="semibold">What’s happening?</Typography>
                    <Typography variant="h4">This will only be shared with {APP_NAME}.</Typography>
                </div>
