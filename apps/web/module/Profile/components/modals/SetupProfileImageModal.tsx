...
interface ISetUpProfileAboutYouModalProps {
  ...
  return (
    <div>
        <ModalContainer title="Add profile picture" onClose={onClose} isOpen={isModalOpen} size="sm">
            <div className='p-5'>
            ...
            {file ? (
             ...
             </div><div className="flex items-center pt-4 md:bottom-0 border-t border-gray-200 rounded-b dark:border-gray-600">
