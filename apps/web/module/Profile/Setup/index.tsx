...
const index = () => {
    ...
    const imageFile = useInputSetupProfileAboutYouStore((state) => state.imageFile);
          ...
          <div className=" lg:col-span-1 mx-auto">
            ...
            <div className="col-span-2">
                <div className='py-6'>
                    ...
                    The information you share will be used across Explore-Siargao to help other guests and Hosts get to know you. <Link href='' className='font-semibold underline'>Learn more</Link>
                    </Typography>
                </div>
              <div>
                <FirstLevel/>
