...
import { ADD_USER_SUCCESS_MESSAGE } from "../constants/index"
...
const SignupInputs = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit2)} className="mx-4 my-4">
      <div className="space-y-4 overflow-y-auto">
        ...
        <div>
          ...
          <p className="text-xs mt-1 text-gray-500 tracking-tighter">
            By selecting <span className="font-bold"> Agree and continue,</span>{" "}
            I agree to Explore Siargao's{" "}
          ...
          <div className="relative flex items-start mt-4">
            ...
            <div className="ml-3 text-xs leading-6">
              <span id="comments-description" className="text-gray-500">
                I don’t want to receive marketing messages from Explore Siargao
              </span>
            </div>
          </div>
        </div>
