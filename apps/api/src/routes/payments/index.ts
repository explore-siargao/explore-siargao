...
import { addpaymentMethod, getPaymentMethods, removePaymentmethod } from './service/paymentMethod'
...
router.delete('/:userId/paymentMethod/remove/:paymentMethodId', isUserLoggedIn, removePaymentmethod)
