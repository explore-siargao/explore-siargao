...
import { E_TransactionStatus, T_AddTransaction, Z_AddTransaction, Z_Transaction } from '@repo/contract'
...
export const updateTransaction = async (req: Request, res: Response) => {
  ...
  if (bookingId) {
    try {
      ...
      const paymentRequest = await apiService.get(`${XENDIT_ROOT_URL}/payment-request`, { id: booking?.xenditPaymentRequestId });
      const statusOption = {
